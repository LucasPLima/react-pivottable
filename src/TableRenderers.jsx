...
export default {
  'Tabela': makeRenderer(),
  'Mapa de Calor': makeRenderer({heatmapMode: 'full'}),
  'Mapa de Calor por Colunas': makeRenderer({heatmapMode: 'col'}),
  'Mapa de Calor por Linhas': makeRenderer({heatmapMode: 'row'}),
