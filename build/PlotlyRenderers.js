...
function createPlotlyRenderers(PlotlyComponent) {
  return {
    ...
    'Gráfico de Barras': makeRenderer(PlotlyComponent, { mode: 'markers' }, {}, true),
    'Gráfico de Área': makeRenderer(PlotlyComponent, { stackgroup: 1 }),
    'Gráfico de Dispersão': makeScatterRenderer(PlotlyComponent),
    'Gráfico Pizza': makeRenderer(PlotlyComponent, { type: 'pie', scalegroup: 1, hoverinfo: 'label+value', textinfo: 'none' }, {}, true)
  };
}
